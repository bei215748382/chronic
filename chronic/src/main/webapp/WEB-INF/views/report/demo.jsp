...
<body>
	...
	<div class="container">
		<div class="info_panel">
			...
			<div class="info">
				<div class="pd-4">
					<span class="margin-left-10">年龄：29</span><span class="pull-right">分析日期：</span>
				</div>
				<div class="pd-4">
					<span class="margin-left-10">性别：男</span><span class="pull-right">2015-12-01</span>
				</div>
			</div>
		</div>
		...
		<div id="score_desc">综合的给出一个描述综合的给出一个描述综合的给出一个描述综合的给出一个描述综合的给出一个描述综合的给出一个描述v综合的给出一个描述v综合的给出一个描述</div>
		<div class="dividing">
			<hr />
		</div>
