...
<div class="row">
	<div id="breadcrumb" class="col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="#"
				onclick="javacript:LoadAjaxContent('user_doc_edit')">修改医生</a></li>
		</ol>
	</div>
</div>
<div class="row">
		...
		<div class="box">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="POST"
					id="defaultForm" action="doctor_edit_json"
					...
					<div class="form-group">
						...
						<div id="localImag" class="col-sm-4">
							<img id="preview" class="img-rounded" src="${doctor.pic}" alt="${doctor.pic}" /> <input
								type="file" name="file"
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<c:if test="${doctor.sex==null || doctor.sex==''}">
								<div class="radio-inline">
									<label> <input type="radio" name="sex" value="男">
										男 <i class="fa fa-circle-o"></i>
									</label>
