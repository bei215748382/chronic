				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-table"></i>
						 <span class="hidden-xs">医生列表</span>
					</a>
					<ul class="dropdown-menu">
...
<!-- 					<a href="#" class="dropdown-toggle"> -->
<!-- 						<i class="fa fa-table"></i> -->
<!-- 						 <span class="hidden-xs">服务信息</span> -->
<!-- 					</a> -->
<!-- 					<ul class="dropdown-menu"> -->
<!-- 						<li><a class="ajax-link" href="services_info.do">信息预览</a></li> -->
<!-- 					</ul> -->
<!-- 				</li> -->
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="data_info.do">信息预览</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-table"></i>
						 <span class="hidden-xs">设备录入</span>
					</a>
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="device_info.do">信息预览</a></li>
					</ul>
				</li>
			</ul>
		</div>
