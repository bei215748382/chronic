		...
		<div class="box">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="POST"
					id="defaultForm" action="medicine_edit_json.do"
					...
					<div class="form-group">
						...
						<div id="localImag" class="col-sm-4">
							<img id="preview" class="img-rounded" alt="图片" src="${medicine.pic}"/>
							<div class="margin-top-15">
								<input id="doc" type="file" name="file"
									onchange="javascript:setImagePreview(this,localImag,preview);" value="${medicine.name}">
							</div>
						</div>
						<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<textarea class="form-control" rows="5" id="description"
								name="description">${medicine.description}</textarea>
						</div>
					</div>
					<div class="form-group">
