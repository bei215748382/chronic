...
public class HttpConstants {
    ...
    public static final String REAL_TIME_SPO_CONTENT_TYPE = "application/x-mlnx-rtspo";

    public static final String SPO_TOKEN_HEADER = "X-MLNX-SPO-Token";

    public static final String SPO_CURRENTPRESSURE_HEADER = "X-MLNX-SPO-CURRENTPRESSURE";

    public static final String SPO_DIASTOLIC_HEADER = "X-MLNX-SPO-DIASTOLIC";

    public static final String SPO_SYSTOLIC_HEADER = "X-MLNX-SPO-SYSTOLIC";

    public static final String SPO_BPHEARTRATE_HEADER = "X-MLNX-SPO-BPHEARTRATE";

    public static final String SPO_BATTERYREMAINING_HEADER = "X-MLNX-SPO-BATTERYREMAINING";

    public static final String SPO_SIGNALSTRENGTH_HEADER = "X-MLNX-SPO-SIGNALSTRENGTH";

    public static final String SPO_SPOSTATE_HEADER = "X-MLNX-SPO-SPOSTATE";

    public static final String SPO_SPO2_HEADER = "X-MLNX-SPO-SPO2";

    public static final String SPO_SPHEARTRATE_HEADER = "X-MLNX-SPO-SPHEARTRATE";
    ...
    public static final String ANNOTATE_CONTENT_TYPE = "application/x-mlnx-annotate";
    ...
    public static final String ECG_SAMPLING_RATE = "X-MLNX-Sampling-Rate";
    ...
    public static final String TOKEN = "nbmlnx";
}
