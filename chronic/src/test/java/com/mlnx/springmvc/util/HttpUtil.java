...
public class HttpUtil {
    ...
    private static Integer connectTimeout = 3000;// 连接超时3秒
    private static Integer socketTimeout = 20000;// socket连接超时20s
    private static String proxyHost = null; // 代理主机
    private static Integer proxyPort = null;// 代理端口
